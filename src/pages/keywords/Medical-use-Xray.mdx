...
import xray from "/src/imgs/keywords/xray_image.webp";
...
<Figure url={xray.src} text='Röntgenaufnahme eines menschlichen Torsos. Es sind die einzelnen Knochen, die Lungen und anderes Gewebe zu erkennen. Bild © stiftung-gesundheitswissen' />
&nbsp;
