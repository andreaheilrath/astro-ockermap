...
Um diesen Prozess genauer zu verstehen, stellen wir uns das Atom als Kugel vor, um das sich, auf Bahnen im immer selben Abstand, Elektronen bewegen. Diese Bahnen nennt man in der Physik Schalen. Je nachdem, welche Ordnungszahl das Atom besitzt, befinden sich mehr oder weniger Elektronen auf jeder Schale. Die Schalen werden von innen nach außen befüllt.

Trifft nun Licht mit einer bestimmten Energie auf das Atom, kann es ein Elektron von einer inneren Schale in eine höhere, äußere Schale anheben. Dabei gibt das Licht seine Energie an das Atom ganz oder in Teilen ab. Das Elektron verlässt nun seine Bahn und bewegt sich ab sofort auf einer anderen Bahn um den Kern des Atoms. Dieser Prozess wird Absorption genannt und ist in Abb. 1 a) dargestellt. E<sub>1</sub> und E<sub>2</sub> sind hier die Bezeichnungen der Schalen (oder auch Energieniveaus), wobei E<sub>1</sub> näher am Atomkern liegt als E<sub>2</sub>.
...
Das aufeinander folgende Absorbieren und Emittieren von Licht wird auch Fluoreszenz genannt.
