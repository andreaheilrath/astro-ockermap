...
<Figure url="/src/imgs/keywords/vis_light_energy.jpg" text='Darstellung des Spektrums von sichtbarem Licht. Nach links hin nimmt die Wellenlänge ab und die Energie zu. Außerdem verschiebt sich die Farbe ins Blaue und dann ins Violette. Nach rechts hin wird die Wellenlänge größer aber auch die Energie kleiner. © NASA, ESA, Leah Hustak (STScI)' />
&nbsp;
